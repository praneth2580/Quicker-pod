...
Primary source: Royal Enfield reprime (com.royalenfield.reprime).
Cross-validated against Super TripperPod (com.supertripper.app v2.1).
See README.md, obfuscation-map.md, and companion docs in this directory.
